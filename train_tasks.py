...
def main():
    ...
    parser.add_argument(
        "--from_pretrained",
        default='save/multitask_model/multi_task_model.bin',  # "bert-base-uncased",
        type=str,
    ...
    task_lr = task_cfg[task]["lr"]

    base_lr = task_lr
    loss_scale = {}
    task = "TASK" + task_id
    loss_scale[task] = task_lr / base_lr
    ...
    task_batch_size, task_num_iters, task_ids, task_datasets_train, \
        task_datasets_val, task_dataloader_train, task_dataloader_val = LoadDatasets(
            args,
            task_cfg,
            args.tasks)
